...
private:
    ...
    void createTauBlockInputs(const TauType& tau, const reco::Vertex& pv, double rho)
    {
        ...
        // PCA coordinates were used as inputs during the NN training, but it was decided to disable
        // them for the inference, because modeliing of dxy_PCA in MC purely describes the data and,
        // on the other hand, these coordinate are strongly era-dependent.
